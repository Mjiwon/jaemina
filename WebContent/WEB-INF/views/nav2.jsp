...
.drop_scroll.dropdown:hover > div.dropdown-menu{display:block; margin:0;} 
	...
	<div class="container-fluid">
		<div class="hedder-up row">
			<div class="col-lg-3 col-md-3 logo-head">
				<h1><a class="navbar-brand" href="${pageContext.servletContext.contextPath }/index.do">JAEMINA</a></h1>
			</div>
			<div class="col-lg-5 col-md-6 search-right">
				<form class="form-inline my-lg-0" action="${pageContext.servletContext.contextPath }/board/searchList.do?currentPage=1" method="post">
			...
			<c:choose>
				...
				<c:when test="${empty auth}">
					<div class="col-lg-3 col-md-3 right-side-cart" id="right_sidebar">
						<div class="cart-icons">
							<ul>
								<li>
									<button style="margin-right: 20px; "><span class="" id="sellstart" style="color:#fff;"> 판매시작</span></button>
								</li>
								<li>
									<button  type="button" data-toggle="modal" data-target="#exampleModal" id="login" name="loginauth"> <span class="" style="font-size: 16px;"> 로그인</span></button>
								</li>
								<li class="toyscart toyscart2 cart cart box_1">
									<form action="#" method="post" class="last">
										...
										<button class="" type="submit" name="submit" value="">
											<span class="far fa-user" id="join" style="font-size: 16px;"> 회원가입</span>
										</button>
									</form>
								</li>
							</ul>
				...
				<c:otherwise>
						...
						<div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
							<ul class="navbar-nav ">
								...
								<li class="nav-item dropdown" style="width:20%; float: left;">
									...
									<ul class="dropdown-menu dropright" style="background-color: white; background-color: white; justify-content: center;">
										<li><a class="dropdown-item" href="${pageContext.servletContext.contextPath }/sellHistory.do"><b style="color: green;">${user.ID }</b>의 재미나</a></li>
										<li><a class="dropdown-item" id="jamilog" href="javascript:jamilog">나의 재미로그</a></li>
										<li class="dropdown-submenu"><a class="dropdown-item dropdown-toggle test" data-toggle="dropdown"> 관심 판매자 목록 <span class="caret"></span></a>
											<ul class="dropdown-menu dropright sub">
												<c:choose>
													<c:when test="${!empty wishlist}">
														<c:forEach var="l" items="${wishlist }">
															<li><a class="dropdown-item" href="${pageContext.servletContext.contextPath }/sellerboardlist.do?seller=${l.SELLER}">${l.SELLER }</a></li>
														</c:forEach>
													</c:when>
													<c:otherwise>
										...
										<li class="dropdown-submenu"><a class="dropdown-item dropdown-toggle test" data-toggle="dropdown">계정설정<span class="caret"></span></a>
											<ul class="dropdown-menu dropright sub">
												<li><a class="dropdown-item" id="changePass" href="javascript:changePass">비밀번호 변경</a></li>
												<li><a class="dropdown-item" id="deleteUser" href="javascript:deleteUser">회원 탈퇴</a></li>
											</ul><a class="dropdown-item" href="${pageContext.servletContext.contextPath }/serviceqa.do">고객센터</a>
											<div class="dropdown-divider"></div><a class="dropdown-item" href="javascript:goLogout();">로그아웃</a>
										</li>
									</ul>
								</li>
	                   		</ul>
									...
									<li><c:choose>
										<c:when test="${!empty chatList }">
											<c:forEach var="i" items="${chatList }">
												<a href="${pageContext.servletContext.contextPath }/qa/buyqa.do?no=${i.no }&writer=${i.writer}&members=${i.member[0]}&members=${i.member[1]}"
					...
					<div id="r_sidebar" style="width: 25%;">
						<ul class="navbar-nav " style="display: inline-block; width:30%;  margin-top:9px; position: absolute; top: 0; right:-130px; margin-top:27px">
							<li class="nav-item"><a class="nav-link disabled" style="float:left;" href="${pageContext.servletContext.contextPath }/write.do"><b>판매글올리기</b></a></li>
							<li class="nav-item"><a class="nav-link disabled" style="float:left;" href="${pageContext.servletContext.contextPath }/addseller.do"><b>판매자 등록하기</b></a></li>
							<li class="nav-item"><a class="nav-link disabled" style="float:left;" href="${pageContext.servletContext.contextPath }/board/lists.do?bigcate=1&currentPage=1"><b>구매</b></a></li>
						</ul>
