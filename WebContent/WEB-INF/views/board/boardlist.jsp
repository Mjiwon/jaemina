...
<div class="row" style="margin-top: 2%;">
	...
	<div class="col-9">
		...
		<c:if test="${!empty searchLog }">
			...
			<c:if test="${currentPage != totalPage }"><a id="lastbtn" href="${pageContext.servletContext.contextPath }/board/searchList.do?searchKey=${searchLog }&currentPage=${totalPage}" style="color: black;"> | [마지막 페이지]</a></c:if>
		</c:if>
		...
		<c:if test="${!empty smallCate }">
			...
			<c:if test="${currentPage != totalPage }"><a id="lastbtn" href="${pageContext.servletContext.contextPath }/board/list.do?bigcate=${bigCate }&smallcate=${smallCate }&currentPage=${totalPage}" style="color: black;"> | [마지막 페이지]</a></c:if>
		</c:if>
	</div>
