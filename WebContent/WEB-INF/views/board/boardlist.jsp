		...
		<ul class="list-group list-group-flush"
			...
			<c:forEach var="i" items="${smallcates}">
				<a class="list-group-item list-group-item-action "
					...
					href="${pageContext.servletContext.contextPath }/board/list.do?bigcate=${i.BIGNO}&smallcate=${i.SMALLNO}&currentPage=1"
					role="tab" aria-controls="v-pills-settings">${i.SMALLCATE }</a>
			</c:forEach>
		</ul>
	</div>
	<div class="col-9">
