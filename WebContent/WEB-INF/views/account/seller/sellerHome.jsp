...
<body class="is-preload">
   ...
   <div id="wrapper">
      ...
      var modifyreply =function() {
         window.open("${pageContext.servletContext.contextPath }/update_seller.do", "판매자 정보 수정", "width=500, height=500, left=700, top=200");
               ...
               <div class="col-md-4">
                  <a href="${pageContext.servletContext.contextPath }/board/detail.do?no=${l.NO}">
                     <div class="card mb-4 shadow-sm">
                        ...
                        <div class="card-body">
                           <p class="card-text">${fn:substring(l.TITLE, 0, 20) }<c:if test="${fn:length(l.TITLE) >20 }">...</c:if></p>
