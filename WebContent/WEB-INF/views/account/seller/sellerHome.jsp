	...
	<section id="header" style="background: #ea1d5d;">
		<header>
			<span class="image avatar"><img
				src="${pageContext.servletContext.contextPath }${Seller.IMGPATH}" /></span>
			<h1 id="logo">
				<a href="#">${Seller.ID }</a>
			</h1>
		...
		<c:if test="${user.ID != Seller.ID }">
			<footer style="background-color: #ea1d5d">
				<ul class="icons">
					<li><a
						href="${pageContext.servletContext.contextPath }/qa/buyqaa.do?writer=${Seller.ID}&members=${Seller.ID}&members=${user.ID}"
						class="icon fa-envelope">문의하기</a></li>
				</ul>
			</footer>
		</c:if>
	</section>
	...
	<div id="wrapper">
		...
		<script type="text/javascript">
			var modifyreply = function() {
				window
						.open(
								"${pageContext.servletContext.contextPath }/update_seller.do",
								"판매자 정보 수정",
		...
		<section id="two">
			...
			<div class="container">
				...
				<ul class="feature-icons">
					<li class="fa-book">총 작업수 :${Seller.myboardcount}개</li>
