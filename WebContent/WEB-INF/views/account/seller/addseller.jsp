...
<body class="is-preload">
	...
	<!-- Header -->
	<header id="header"><!-- style="background-color: #000; opacity: 0.5;" -->
...
<body class="is-preload">
	...
	<!-- Contact -->
	<section id="contact" class="main style3 secondary"
		style="background-color: #CB98A6">
		<div class="content">
			<header>
				<h2 style="color: white;">판매자 등록하기</h2>
				<p style="color: white;"></p>
			</header>
			<div class="box" style="background-color: #CB98A6">
				<form
					action="${pageContext.servletContext.contextPath }/addseller.do"
					method="post" enctype="multipart/form-data">
					<div class="fields">
