...
<div class="container">
	...
	<c:choose>
		...
		<c:otherwise>
		<div class="row" style="text-align: center; border: 1px solid gray; border-radius: 2px; padding-top: 3px;">
			<div class="col"><b>제  목</b></div>
			<div class="col-md-auto""><b>시간</b></div>
			<div class="col col-lg-2"><b>답변상태</b></div>
			<button type="button" class="btn" data-toggle="modal" data-target="#exampleModalLong" style="height:36px; background-color: white; color: white;">보기</button>
			</div>
			<c:forEach var="re" items="${receive }" varStatus="status">
				<div class="row" style=" padding-top: 4px;">
					...
					<button type="button" class="btn" data-toggle="modal"
						data-target="#exampleModalLong${status.index }" style="height:36px;">보기</button>
				</div>
