		...
		<div class="row">
			<div class="col-md-4 order-md-2 mb-4">
				<h4 class="d-flex justify-content-between align-items-center mb-3">
					<span class="text-muted">판매자 정보</span> <span
			...
			<div class="col-md-8 order-md-1">
				...
				<form class="needs-validation" action="${pageContext.servletContext.contextPath }/qa/buyqa.do?no=${detail.NO }&writer=${detail.WRITER}" novalidate>
					<div class="mb-3">
					...
					<hr class="mb-4">
					<button class="btn btn-primary btn-lg btn-block" type="submit">판매자에게 문의하기</button>
				</form>
			</div>
		</div>
